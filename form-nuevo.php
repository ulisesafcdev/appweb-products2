...
$query = "INSERT INTO usuarios(usuario, pass, telefono, direccion, activo) VALUES(?, ?, ?, ?, ?)";

$stm = $mysqli->prepare($query);
$stm->bind_param('ssisi', $usuario, $pass, $telefono, $direccion, $estado);
...
<body>
    ...
    <nav class="navbar navbar-dark bg-dark">
        <div class="container-fluid">
            <a class="navbar-brand">Usuario ingresado</a>
